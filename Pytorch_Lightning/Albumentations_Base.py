...
class Test_Load_Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #sample = {'image': self.Grayscale(augmented.float() / 255), 'labels': labels}#If you want to use grayscale image
        sample = {'image': augmented.float() / 255, 'labels': labels}
        return sample
...
class DataModule(pl.LightningDataModule):
    def __init__(self):
        ...
        transforms_Cls = albumentations.Compose([
